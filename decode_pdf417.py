...
barcode_image = "pdf_417_variants/to_decode.jpg"
...
try:
    ...
    result = subprocess.run(docker_command, capture_output=True, text=True, check=True, errors="replace", encoding="utf-8")
